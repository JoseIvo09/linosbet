document.addEventListener("DOMContentLoaded", function() {
    ...
    // Função toggleSidebar definida antes de ser usada
    ...
    myFrame.onload = function() {
        try {
            const script = myFrame.contentDocument.createElement('script');
            script.textContent = '(' + blockElements.toString() + ')()';
            myFrame.contentDocument.body.appendChild(script);
        } catch (e) {
            console.error("Erro ao adicionar o script ao iframe: ", e);
        }
    };
});